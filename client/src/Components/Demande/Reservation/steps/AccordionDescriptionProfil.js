...
export default function AccordionDescriptionProfil(props) {
  const [sections, setSections] = useState([
    ...
    <MonProfilModif  nom={props.nom} prenom={props.prenom} adresse={props.adresse}
         email={props.email} telephone={props.telephone}
         codePostal={props.codePostal} username={props.username}  />
